...
export interface IContentRepository {
  ...
  updateSection(id: string, data: Partial<ContentSection>): Promise<ContentSection>;
  ...
  createPageVersion(data: InsertPageVersion, createdBy?: string): Promise<PageVersion>;
  restorePageVersion(pageId: string, versionId: string, userId?: string): Promise<Page>;
